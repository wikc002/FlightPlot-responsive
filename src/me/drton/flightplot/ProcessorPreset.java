...
public class ProcessorPreset {
    ...
    public Map.Entry<String, Object> getParameter(int i) {
        java.util.List<Map.Entry<String, Object>> paramEntries = new ArrayList<Map.Entry<String, Object>>(parameters.entrySet());
        Collections.sort(paramEntries, new Comparator<Map.Entry<String, Object>>() {
            @Override
            public int compare(Map.Entry<String, Object> o1, Map.Entry<String, Object> o2) {
                return o1.getKey().compareTo(o2.getKey());
            }
        });
        java.util.List<Map.Entry<String, Object>> colorsEntries = new ArrayList<Map.Entry<String, Object>>();
        for (Map.Entry<String, Color> entry : colors.entrySet()) {
            colorsEntries.add(new AbstractMap.SimpleImmutableEntry<String, Object>(entry.getKey(), entry.getValue()));
        }
        Collections.sort(colorsEntries, new Comparator<Map.Entry<String, Object>>() {
            @Override
            public int compare(Map.Entry<String, Object> o1, Map.Entry<String, Object> o2) {
                return o1.getKey().compareTo(o2.getKey());
            }
    ...
    public ProcessorPreset clone() {
        ProcessorPreset p = new ProcessorPreset(title, processorType, new HashMap<String, Object>(parameters), new HashMap<String, Color>(colors), visible);
        p.setUiLanguage(this.uiLanguage);
        return p;
    }
